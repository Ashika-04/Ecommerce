...
//     type: 'SET_FULLBOX_ON',
//   });
// }, [ctxDispatch, userInfo.token]); // ✅ Added userInfo.token
...
export default function MapScreen() {
  ...
  if (!googleApiKey) {
    return (
      <div className="full-box loading">
  ...
  return (
    <div className="full-box">
      ...
      <button className="location-button" onClick={getUserCurrentLocation}>
      ...
      <div className="instructions">
        Search for an address or drag the map to select your location
      </div>
    </div>
  );
}